        ...
        {isLoading || !applicant ? (
          ...
          <div className="space-y-8">
            ...
            <Section title="ข้อมูลส่วนตัว">
              ...
              <InfoRow label="วันเกิด" value={formatThaiDate(applicant.birthDate)} />
            ...
            <Section title="สถานะและการยินยอม">
              ...
              <InfoRow label="วันที่ยื่นใบสมัคร" value={formatThaiDateTime(applicant.submittedAt)} />
              <InfoRow label="วันที่ตรวจสอบ" value={formatThaiDateTime(applicant.reviewedAt)} />
              <InfoRow label="ยินยอม PDPA" value={applicant.pdpaConsent ? 'ยินยอม' : 'ไม่ยินยอม'} />
              <InfoRow label="วันที่ให้ความยินยอม" value={formatThaiDateTime(applicant.consentedAt)} />
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <div className="flex gap-4">
                  <FormField label="เกิด วันที่/เดือน/พ.ศ." value={formatPrintDate(applicant.birthDate)} className="flex-[2]" />
